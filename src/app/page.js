  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 md:p-8 bg-gray-50">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-center mb-2">Excel Data Viewer</h1>
      ...
      {validationResults && (
        <div className="mb-8">
          ...
          <div className={`p-4 rounded-md ${validationResults.valid ? 'bg-green-100' : 'bg-red-100'}`}>
            <p className={`font-medium ${validationResults.valid ? 'text-green-700' : 'text-red-700'}`}>
              {validationResults.valid ? 'Data is valid!' : 'Data has validation errors'}
            </p>
