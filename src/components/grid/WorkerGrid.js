  ...
  const [columnDefs] = useState([
    ...
    { 
      ...
      valueSetter: params => {
        ...
        params.data.Skills = params.newValue.split(',').map(skill => skill.trim());
        return true;
      }
    },
    { 
      ...
      valueSetter: params => {
        try {
          ...
          params.data.AvailableSlots = params.newValue.split(',').map(slot => parseInt(slot.trim()));
          return true;
        } catch (error) {
    ...
    { field: 'QualificationLevel', headerName: 'Qualification Level', editable: true }
  ]);
